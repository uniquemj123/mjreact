    ...
    <>
      <div className='hero' >
        <div className='container text-light text-center pt-5'>
          <h1 className='pt-5' style={{ marginTop: '5px' }}> Easy qnd quick cargo shipping services </h1>
          <p style={{ fontsize: '24px' }}>Book low cost sea freight shipping services. get instant quote</p>
      ...
      <div className="container pt-5">
        ...
        <div className="row">
          <div className="col-md-6" data-aos="fade-up">
            <img src={Smiling} className='img-fluid rounded ' alt="" />
          </div>
        ...
        <div className="container pt-5">
          <div className='text-center' data-aos="fade-up">
            ...
            <h2><b>Covering All Logistics Fields</b></h2>
          </div>
        </div>
        <Card />
        <div className='text-center' data-aos="fade-up">
