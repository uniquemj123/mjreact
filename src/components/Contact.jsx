      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4 mt-5" data-aos="fade-up">
            ...
            <div className="">
              <div className="mb-3">
                <a href="tel:07069553344" className='text-decoration-none text-dark'>
                  <span className="me-3">
              ...
              <div className="mt-3">
                <a href="https://wa.me/+2347069553344" className='text-decoration-none text-dark'>
                  <span className="me-3">
              ...
              <div className="mt-3">
                <a href="mailto:nwankwojane2015@gmail.com" className='text-decoration-none text-dark'>
                  <span className="me-3">
                    <i className="fa fa-envelope"></i>
                  </span>
                  nwankwojane2015@gmail.com
                </a>
              </div>
            </div>
          </div>
